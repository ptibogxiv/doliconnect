...
//if ( in_the_loop() && is_main_query() && is_page(doliconnectid('doliaccount')) ) {
...
} elseif ( has_action('supplier_doliconnect_'.esc_attr($_GET['module'])) && $thirdparty->fournisseur == '1' && get_option('doliconnectbeta')=='1' ) {
...
$content .= "vous ne b�n�ficierez pas a priori d'exonerations fiscales";
}
$content .= "</div>";
}
