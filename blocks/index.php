...
require_once ( WP_PLUGIN_DIR . '/' . dirname( plugin_basename( __DIR__ ) ) . '/blocks/agenda/block.php' );
require_once ( WP_PLUGIN_DIR . '/' . dirname( plugin_basename( __DIR__ ) ) . '/blocks/membership.php' );
...
require_once ( WP_PLUGIN_DIR . '/' . dirname( plugin_basename( __DIR__ ) ) . '/blocks/product.php' );
require_once ( WP_PLUGIN_DIR . '/' . dirname( plugin_basename( __DIR__ ) ) . '/blocks/product/blockdiscount.php' );
