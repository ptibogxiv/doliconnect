 ...
 * BLOCK: thirdparty
 *
 * Gutenberg Custom thirdparty Block assets.
 *
 * @since   1.0.0
 * @package OPB
 */
...
function doliconnect_thirdparty_block() {

	// Scripts.
	wp_register_script(
		'doliconnect-thirdparty-block-script', // Handle.
	...
	// Styles.
	wp_register_style(
		'doliconnect-thirdparty-block-editor-style', // Handle.
	...
	wp_register_style(
		'doliconnect-thirdparty-block-frontend-style', // Handle.
		plugins_url( 'style.css', __FILE__ ), // Block editor CSS.
		array( 'wp-edit-blocks' ) // Dependency to include the CSS after it.
	);  

function doliconnect_thirdparty_render_block( $attributes ) {
global $current_user;
...
return $html;
	...
	register_block_type( 'doliconnect/thirdparty-block', array(
    'render_callback' => 'doliconnect_thirdparty_render_block',
		'editor_script' => 'doliconnect-thirdparty-block-script',
		'editor_style' => 'doliconnect-thirdparty-block-editor-style',
		'style' => 'doliconnect-thirdparty-block-frontend-style',
	) );

} // End function organic_profile_block().

// Hook: Editor assets.
add_action( 'init', 'doliconnect_thirdparty_block' );