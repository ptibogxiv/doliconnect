...
global $current_user;
	...
	if (isset($_POST['case']) && $_POST['case'] == "updateline") {
		...
		if (isset($_POST['modify']) && $_POST['modify'] == "delete") { 
			...
			wp_send_json_success($response);	
			die(); 
		} elseif (isset($_POST['modify']) && ($_POST['modify'] == "plus" || $_POST['modify'] == "minus" || $_POST['modify'] == "modify") && (($_POST['qty']-$mstock['step']>=0 && $_POST['modify'] == "minus") || ($_POST['qty']>=0 && $_POST['modify'] == "modify")) && ($_POST['qty']+$mstock['step'])<=max(array($mstock['m2'],$mstock['qty']))) { 
