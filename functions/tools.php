...
if ( function_exists('secupress_get_module_option') && isset(get_site_option('doliconnect_login')) && secupress_get_module_option('move-login_slug-login', null, 'users-login' )) {
