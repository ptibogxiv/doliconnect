...
print "><input type='text' aria-label='NAF-APE' placeholder='".__( 'NAF-APE', 'doliconnect')."' name='".$idobject."[idprof3]' maxlength='5' value='".$object->idprof3."' class='form-control'><input type='text' aria-label='RCS/RM' placeholder='".__( 'RCS/RM', 'doliconnect')."' class='form-control'></div></div></div>";
}
...
//} else {
if ( $realstock-$line->qty >= 0 && (empty($product->type) || (!empty($product->type) && doliconst('STOCK_SUPPORTS_SERVICES', $refresh)) ) ) {
