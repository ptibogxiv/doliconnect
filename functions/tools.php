...
print "<div class='custom-control custom-checkbox'><input type='checkbox' class='custom-control-input' name='".$idobject."[roles][".$contacttype->rowid."]' id='".$idobject."[roles][".$contacttype->rowid."]' ";
