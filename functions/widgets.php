...
if ( !empty($instance['display']) || (is_singular('doliproduct')) || (term_exists('doliproduct_category')) || (empty($instance['display']) && is_page(doliconnectid('dolishop')) && !empty(doliconnectid('dolishop'))) ) { 
