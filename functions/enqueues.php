...
function doliconnect_enqueues() { 
	...
	if (empty(get_option('doliconnectfontawesome'))) {
  		wp_register_script( 'font-awesome', '//use.fontawesome.com/releases/v6.5.1/js/all.js', array(), '6.5.1' );
	...
	wp_enqueue_style( 'bootstrap-social');
  	wp_register_style( 'flag-icons', plugins_url( 'doliconnect/includes/flag-icons/css/flag-icons.css' ), array(), '7.2.1' ); 
