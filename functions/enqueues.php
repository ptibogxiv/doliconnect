...
$version=$versionbase;
  ...
  if (empty(get_option('doliconnectfontawesome'))) {
  	wp_register_script( 'font-awesome', '//use.fontawesome.com/releases/v6.1.1/js/all.js', array(), '6.1.1' );
	...
	wp_enqueue_style( 'bootstrap-social');
  	wp_register_style( 'flag-icon-css', plugins_url( 'doliconnect/includes/flag-icon-css/css/flag-icons.css'), array(), '4.6.2'); 
