...
$message = '<div class="card" >
  <div class="card-body">
    ...
    <p class="card-text"><h2>'.__( 'Your order has been registered', 'doliconnect').'</h2>'.__( 'Reference', 'doliconnect').': '.$object->ref.'<br>'.__( 'Payment method', 'doliconnect').': '.$object->mode_reglement_code.'</p>';
