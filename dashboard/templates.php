...
print "<li class='list-group-item' id='prod-li-".$product->id."'><table width='100%' style='border:0px'><tr><td style='border:0px'><center><i class='fa fa-cube fa-fw fa-2x'></i></center></td>";
